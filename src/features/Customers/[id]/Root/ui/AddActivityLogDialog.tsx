...
type AddActivityLogDialogProps = {
  isOpen: boolean
...
export const AddActivityLogDialog = ({
  isOpen,
  activityLogForm,
  errors,
        ...
        <Dialog.Positioner>
          <Dialog.Content>
            ...
            <Dialog.Footer>
              ...
              <Button colorPalette='blue' loading={isCreatingActivityLog} onClick={onSubmit}>
                Save
              </Button>
            </Dialog.Footer>
          </Dialog.Content>
